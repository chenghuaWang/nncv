...
class Conv2d1x1ToMatMul : public mlir::nncv::ConvertConv2DToImg2ColBase<Conv2d1x1ToMatMul> {
...
std::unique_ptr<mlir::Pass> createConvertConv2D1x1ToMatmulPass() {
  return std::make_unique<Conv2d1x1ToMatMul>();
}
}  // namespace mlir::nncv