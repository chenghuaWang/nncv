...
func.func @matmul(%a: tensor<128x256xf32>,  %b: tensor<256x64xf32>,  %c: tensor<128x64xf32>) -> tensor<128x64xf32> {
    %c_out = linalg.matmul ins(%a, %b: tensor<128x256xf32>, tensor<256x64xf32>) outs(%c: tensor<128x64xf32>) -> tensor<128x64xf32>
    return %c_out : tensor<128x64xf32>
}

func.func @main() {
    %lhs = tensor.empty() : tensor<128x256xf32>
    %rhs = tensor.empty() : tensor<256x64xf32>
    %dst = tensor.empty() : tensor<128x64xf32>
    %start_time = call @_mlir_ciface_nanoTime() : () -> i64
    %dst_0 = call @matmul(%lhs, %rhs, %dst) : (tensor<128x256xf32>, tensor<256x64xf32>, tensor<128x64xf32>) -> tensor<128x64xf32>
