module @__main {
  ...
  func.func private @add(%arg0: memref<1024x1024xf32>, %arg1: memref<1024x1024xf32>, %arg2: memref<1024x1024xf32>) {
  ...
  func.func private @main() {
    ...
    call @add(%alloc, %alloc_0, %alloc_1) : (memref<1024x1024xf32>, memref<1024x1024xf32>, memref<1024x1024xf32>) -> ()
